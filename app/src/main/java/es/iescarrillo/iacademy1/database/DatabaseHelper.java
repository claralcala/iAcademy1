...
* */
    @Database(entities = {Manager.class, Academy.class, Course.class, Student.class, Inscription.class,Admin.class, Classroom.class, Lesson.class, Teacher.class}, version = 2)
